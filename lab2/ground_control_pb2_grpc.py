...
class GroundControlStub(object):
    ...
    def __init__(self, channel):
        ...
        self.sharePIN = channel.unary_unary(
                '/GroundControl/sharePIN',
                request_serializer=ground__control__pb2.pinRequest.SerializeToString,
                response_deserializer=ground__control__pb2.pinReply.FromString,
                )
        self.checkCompleted = channel.unary_unary(
                '/GroundControl/checkCompleted',
                request_serializer=ground__control__pb2.checkRequest.SerializeToString,
                response_deserializer=ground__control__pb2.checkReply.FromString,
                )
...
def add_GroundControlServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'sharePIN': grpc.unary_unary_rpc_method_handler(
                    servicer.sharePIN,
                    request_deserializer=ground__control__pb2.pinRequest.FromString,
                    response_serializer=ground__control__pb2.pinReply.SerializeToString,
            ),
            'checkCompleted': grpc.unary_unary_rpc_method_handler(
                    servicer.checkCompleted,
                    request_deserializer=ground__control__pb2.checkRequest.FromString,
                    response_serializer=ground__control__pb2.checkReply.SerializeToString,
            ),
    }
...
class GroundControl(object):
    ...
    def sharePIN(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/GroundControl/sharePIN',
            ground__control__pb2.pinRequest.SerializeToString,
            ground__control__pb2.pinReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def checkCompleted(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/GroundControl/checkCompleted',
            ground__control__pb2.checkRequest.SerializeToString,
            ground__control__pb2.checkReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
